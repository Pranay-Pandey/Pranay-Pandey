...
<!--
**Pranay-Pandey/Pranay-Pandey** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
<p>
    ...
    <h1>Skills</h1>
    <ul>
      <li>Collaborative approach to software development</li>
      <li>Ability to prepare design documents, specifications, and estimates</li>
      <li>Strong research and data analysis skills</li>
      <li>Experience in developing efficient systems and conducting literature reviews</li>
    </ul>
    <h1>Background</h1>
    <p>
